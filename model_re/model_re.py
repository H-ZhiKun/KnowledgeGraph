...
class config:
    ...
    PATH_SCHEMA = "E:/dev/python/DrillingKG/data/model_re/predicate.json"
    PATH_TRAIN = 'E:/dev/python/DrillingKG/data/model_re/train_data.json'
    PATH_BERT = "E:/dev/python/DrillingKG/data/model_re"
    PATH_MODEL = "E:/dev/python/DrillingKG/data/model_re/model_re.pkl"
    PATH_SAVE = 'E:/dev/python/DrillingKG/data/save_re.pkl'
    tokenizer = BertTokenizer.from_pretrained("E:/dev/python/DrillingKG/data/model_re/" + 'vocab.txt')
